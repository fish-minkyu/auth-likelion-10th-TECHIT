...
public class AllAuthenticatedFilter extends OncePerRequestFilter { // OncePerRequestFilter: 필터를 한번만 실행시키게 해주는 필터
  ...
  protected void doFilterInternal(
    ...
    // TODO 여기서부터
    // 헤더를 포함하고 있는지 테스트
    // 헤더에 "x-likelion-all-auth: true"가 포함된 요청은 로그인한 요청이다.
